...
import org.apache.flink.table.planner.expressions.utils.{ArrayTypeTestBase, MultiSetTypeTestBase}
import org.apache.flink.table.planner.utils.DateTimeTestUtil.{localDate, localDateTime, localTime => gLocalTime}
import org.junit.Test

class MultiSetTypeTest extends MultiSetTypeTestBase {

  @Test
  def testInputTypeGeneralization(): Unit = {
    testSqlApi("f0 = f1", "false")
  }
